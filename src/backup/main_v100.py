...
class LadderGame(ft.Container):
    ...
    def __init__(self, page: ft.Page, edit_callback): # Modified: Changed info_dialog to edit_callback
        super().__init__()
        self.page = page
    ...
    # --- No changes above this line in LadderGame ---
    ...
    # --- No changes in generate_horizontal_lines ---
    ...
    # --- No changes in draw_vertical_lines, get_line_spacing, get_min_y_distance, start_game, animate_line, blink_result_box, update, new_game, generate_ladder, toggle_log_visibility ---
    ...
    # --- Added: Method to blink the generate icon ---
...
def main(page: ft.Page):
    ...
    # --- Modified: Moved dialog closing logic to a helper ---
    def close_any_dialog(dlg, e):
        page.close(dlg)

    # --- Modified: Renamed dlg to info_dlg for clarity ---
    info_dlg = ft.AlertDialog(
        ...
        content=ft.Column(
            [
                ...
                ft.Text("Ver: 0.9.1", color="black", size=16), # Version bump
    ...
    # --- Added: Function to show the result editing dialog ---
    def show_edit_result_dialog(index, result_box_control: ft.TextField):
        ...
        def save_and_close(e):
            ...
            page.close(edit_dialog) # Close the dialog
    ...
    # --- Removed the old show_edit_result_box function ---

    # --- Modified: Pass the new edit callback function to LadderGame ---
    ladder_game = LadderGame(page, edit_callback=show_edit_result_dialog)
    ...
    page.appbar = ft.AppBar(
        ...
        actions=[
            ...
            # Modified: Ensure the Author button opens the info_dlg
            ft.IconButton(
